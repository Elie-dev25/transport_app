...
# Route pour les alertes de documents administratifs
@admin_only
...
def documents_alerts_ajax():
    ...
    docs = DocumentBusUdM.query.filter(DocumentBusUdM.date_expiration != None).all()
...
# Route pour les alertes carburant
@admin_only
